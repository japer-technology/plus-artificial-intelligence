...
2. Publish a licence manifest (e.g. `site-v2/licensing.html` + `site-v2/licence-manifest.json`) mapping each asset class — code, specification text, reviewed translations, themes, schemas, public registry data — to the licence chosen in §2 D1–D4, with each licence's canonical text URL.
...
- `site-v2/licensing.html` — the licensing and mark policy page.
- `site-v2/licence-manifest.json` — the licence manifest mapping asset class → licence.
