...
## 1. Task details
- **Split approval boundaries:** C may exercise [0091 §8.8 X32 closure rehearsal](0091-experiments-and-metrics.md#88-speculative-catalogue--all-40-scheduled) with a permitted bundle reconstructed elsewhere; E managed hosting requires its own demand, cost, recovery and exit gate. Hosted mail components (including bundled aliases/relay) and broad external identity are separately deferred F reviews under [§8.9](0091-experiments-and-metrics.md#89-rejected-mechanisms-and-deferred-service-register), never implied by hosting/domain approval. Each needs a separately approved case and applicable consent, authentication, abuse, retention, cost and failure/exit evidence.
- **Address continuity:** Coordinate 0022/0034/0079 before domain operations: cancellation, expiry or rename must not silently change the party referenced by old identity-bearing URLs. Protect the referent, not only the internal record ID; use lawful privacy-safe retirement rather than recycled identity addresses or indefinite personal-data promises.
...
4. **Gate dependency, not a decision here:** 0050 supplies observed adoption measures and 0091 study methods; 0008's designated deciding body records required evidence and criteria before evaluation. The E hosting gate is not satisfied by a count or an inherited P4 label, and cannot approve the separate F mail/identity reviews.
